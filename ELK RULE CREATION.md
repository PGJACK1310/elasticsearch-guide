...
1. Step 1 : match the keyword and identify the relevant SIEM logs.
<img width="1365" height="623" alt="image" src="https://github.com/user-attachments/assets/7b3bec72-20d2-4288-9e96-f25c219c25e5" />
2. Step 2 : Navigate to Elastic Security and select the Custom Query rule type to define the SIEM detection logic.
